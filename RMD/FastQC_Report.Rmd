...
num<-length(images)
###Problem: order of select paths is wrong so incorrect images are being picked in the order of select paths. Change that order to fix. changed rbind to cbind in 102

for(l in length(inFilePaths))
